...
public class StoragePlatformStructure extends StructureFeature<StructurePoolFeatureConfig> {

    public StoragePlatformStructure(Codec<StructurePoolFeatureConfig> codec) {
        // Create the pieces layout of the structure and give it to the game
        super(codec, StoragePlatformStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!StoragePlatformStructure.isFeatureChunk(context)) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(
                ...
                () -> context.registryManager().get(Registry.STRUCTURE_POOL_KEY)
                        .get(new Identifier(MCCourseMod.MOD_ID, "storage_platform/start_pool")),
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            MCCourseMod.LOGGER.log(Level.DEBUG, "Rundown House at " + blockpos);
        }
